...
public interface Constants {
  ...
  int CREATE_WALLET_STEP_INIT = 1;
  int CREATE_WALLET_STEP_VERIFICATION = 2;
  int CREATE_WALLET_STEP_ENCRYPTION = 3;
  int CREATE_WALLET_STEP_ERROR = 4;
  int CREATE_WALLET_STEP_COMPLETE = 5;
  int CREATE_WALLET_STEP_CHECK_FAILED = 6;
