...
public interface Constants {
  ...
  int IMPORT_WALLET_STEP_INIT = 1;
  int IMPORT_WALLET_STEP_PASSPHRASE = 2;
  int IMPORT_WALLET_STEP_ENCRYPT = 3;
  int IMPORT_WALLET_STEP_ERROR = 4;
  int IMPORT_WALLET_STEP_SUCCESS = 5;
